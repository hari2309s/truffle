  ...
  en: {
    ...
    pricing: {
      ...
      pro: {
        ...
        features: [
          'Everything in Free',
          'Unlimited receipt & PDF scanning',
          'Voice transcription',
      ...
      finePrint: 'Cancel anytime. Billed monthly. No hidden fees.',
    },
    finalCta: {
        ...
        sections: {
          ...
          thirdParty: {
            ...
            items: [
              ...
              {
                name: 'Stripe',
                desc: 'Payment processing for Pro subscriptions. Card details are handled entirely by Stripe and never reach our servers.',
              },
  ...
  de: {
    ...
    pricing: {
      ...
      pro: {
        ...
        features: [
          'Alles aus Kostenlos',
          'Unbegrenzte Kassenbon- & PDF-Scans',
      ...
      finePrint: 'Jederzeit kündbar. Monatliche Abrechnung. Keine versteckten Kosten.',
    },
    finalCta: {
        ...
        sections: {
          ...
          thirdParty: {
            ...
            items: [
              ...
              {
                name: 'Stripe',
                desc: 'Zahlungsabwicklung für Pro-Abonnements. Kartendaten werden vollständig von Stripe verarbeitet und erreichen unsere Server nie.',
              },
